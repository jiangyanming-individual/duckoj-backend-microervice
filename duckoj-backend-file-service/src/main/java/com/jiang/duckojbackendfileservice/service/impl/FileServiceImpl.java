package com.jiang.duckojbackendfileservice.service.impl;
...
import com.jiang.duckojbackendfileservice.utils.FileUtils;
...
public class FileServiceImpl implements FileService {
     ...
     */
    @Override
    public String uploadFileAvatar(MultipartFile file,String fileName) {
        ...
        try {
            ...
            // 关闭OSSClient。
            ossClient.shutdown();
            // 把上传后文件路径返回，需要把上传到阿里云oss路径手动拼接出来，在阿里云控制台显示
